...
| 035 | [Block structure inside containers: list items and blockquotes](./accepted/035-block-structure-inside-containers.md) — [handoff](./handoffs/035-block-structure-inside-containers/implementation-handoff.md) | M3 → `2.3.0` | **P0** — **next, handed over 2026-09-17** (18 cells) |
