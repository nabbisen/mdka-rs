...
| ID | Title | State |
|----|-------|-------|
| 048 | [The `3.0` surface: one result model, one convention per language, two modes](./accepted/048-the-3.0-surface.md)  — [`2.9.0` precondition](./handoffs/048-the-3.0-surface/2.9.0-precondition-handoff.md) · [`2.9.0` API reference](./handoffs/048-the-3.0-surface/2.9.0-api-reference-handoff.md) · [slice 1: removals](./handoffs/048-the-3.0-surface/slice-1-removals-handoff.md) · [slice 2: result model](./handoffs/048-the-3.0-surface/slice-2-result-model-handoff.md) · [2 addendum: cache](./handoffs/048-the-3.0-surface/slice-2-addendum-2026-09-26-cache.md) · [2 addendum 2: cache key](./handoffs/048-the-3.0-surface/slice-2-addendum-2026-09-26b-cache-key.md) · [slice 3: migration guide](./handoffs/048-the-3.0-surface/slice-3-migration-guide-handoff.md) · [`3.0.0` prep](./handoffs/3.0.0-release-prep/prep-handoff.md) | **Accepted (owner, 2026-09-25); §11 answered the same day.** Resolves RFC 039 Half B and RFC 041 §5.1 together. **No conversion output changes.** `3.0` ships **immediately after `2.9.0`**, which is a precondition, not an option — §7. **The `2.9.0` precondition ships in `2.9.0`** — `unwrap_unknown_wrappers` deprecated on all four surfaces, the string-form behaviour pinned, and the API reference made tri-lingual; **everything else is `3.0`.** Stays in `accepted/` |
| 041 | [The conversion surface: options that cannot act, modes that cannot differ](./accepted/041-conversion-surface-honesty.md) — [§6.2 wording slice](./handoffs/041-conversion-surface-honesty/wording-slice-handoff.md) · [help-text follow-up](./handoffs/041-conversion-surface-honesty/help-text-slice-handoff.md) | **Accepted; §6 answered 2026-09-24** — collapse at `3.0`, decided with RFC 039 Half B, and the honest wording ships early. **§6.2's wording half shipped in `2.6.0`.** **The deprecation slice ships in `2.8.0`** — [handoff](./handoffs/041-conversion-surface-honesty/deprecation-slice-handoff.md) · [addendum](./handoffs/041-conversion-surface-honesty/deprecation-slice-addendum-2026-09-25.md) — `Strict`, `Semantic` and `Preserve` deprecated on all four surfaces, nothing removed: the runway `3.0` needs before it can remove anything. **Still open, `3.0`:** the §9 removal and the §10 `parse_mode` decision, with RFC 039 Half B. Stays in `accepted/` |
