...
| 034 | [PyPI: a declared wheel matrix, built on purpose and checked where it is published](./accepted/034-pypi-declared-wheel-matrix.md) — [handoff](./handoffs/034-pypi-declared-wheel-matrix/implementation-handoff.md) | M3 → `2.3.0` | **P1** — slice 034 ✅ approved; **034b next** ([follow-up](./handoffs/034-pypi-declared-wheel-matrix/followup-034b.md)); before the cut |
