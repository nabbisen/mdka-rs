...
| 010 | [Escaping and text round-trip](./accepted/010-escaping-and-text-round-trip.md) — [handoff](./handoffs/010-escaping-and-text-round-trip/implementation-handoff.md) | M3 → `2.3.0` | **P0** — **next, handed over 2026-09-17** (28 cells) — last in `2.3.0` |
