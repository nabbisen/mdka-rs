...
| `link_around_p_in_li` | `<ul><li><a href="/x"><p>x</p></a></li></ul>` | `ul(li(link[/x]("x")))` — *added 2026-09-17, RFC 028 review* |
...
1. The 18 §4 cells added first; every one that fails at the base commit marked, and every marker removed by
