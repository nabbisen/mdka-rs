...
- [Usage & Examples](./getting-started/usage.md)
  - [Rust](./getting-started/usage-rust.md)
  - [Node.js](./getting-started/usage-nodejs.md)
  - [Python](./getting-started/usage-python.md)
...
- [Supported HTML Elements](./api/elements.md)
- [Text Processing Rules](./api/text-processing.md)
